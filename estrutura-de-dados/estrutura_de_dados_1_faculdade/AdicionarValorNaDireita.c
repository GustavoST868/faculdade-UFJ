...
tipodoItem adicionarDireita(int novoValor, int valorExistente, tipodoItem lista)
{
    ...
    while (listaAuxiliar != NULL && listaAuxiliar->valor != valorExistente)
    {
        listaAuxiliar = listaAuxiliar->proximo;
    }
...
int main()
{
    ...
    printf("\n");
    lista = adicionarDireita(11, 3, lista);
